...
*/
public class CollectionBookBeanDao extends AbstractDao<CollectionBookBean, String> {
    ...
    protected final void bindValues(DatabaseStatement stmt, CollectionBookBean entity) {
        ...
        String bookTag = entity.getBookTag();
        if (bookTag != null) {
    ...
    @Override
    protected final void attachEntity(CollectionBookBean entity) {
    ...
    @Override
    protected final String updateKeyAfterInsert(CollectionBookBean entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(CollectionBookBean entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
