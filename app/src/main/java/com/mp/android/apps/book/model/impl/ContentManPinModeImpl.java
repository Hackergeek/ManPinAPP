...
public class ContentManPinModeImpl extends MBaseModelImpl implements IReaderBookModel {
    public static final String TAG = "http://aimanpin.com";

    public static ContentManPinModeImpl getInstance() {
        return new ContentManPinModeImpl();
    }

    private ContentManPinModeImpl() {
    }
