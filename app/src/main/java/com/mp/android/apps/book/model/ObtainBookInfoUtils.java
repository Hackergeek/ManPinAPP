...
public class ObtainBookInfoUtils extends MBaseModelImpl {
    ...
    public SourceListContent translateBookInfo(CollectionBookBean collBookBean) {
    ...
    public void senMessageManpin(CollectionBookBean collBookBean, String kind, String lastChapter) {
        try {
