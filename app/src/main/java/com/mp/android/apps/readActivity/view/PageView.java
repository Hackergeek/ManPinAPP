...
import com.mp.android.apps.readActivity.view.animation.CoverPageAnim;
import com.mp.android.apps.readActivity.view.animation.HorizonPageAnim;
import com.mp.android.apps.readActivity.view.animation.NonePageAnim;
import com.mp.android.apps.readActivity.view.animation.PageAnimation;
import com.mp.android.apps.readActivity.view.animation.ScrollPageAnim;
import com.mp.android.apps.readActivity.view.animation.SimulationPageAnim;
import com.mp.android.apps.readActivity.view.animation.SlidePageAnim;
import com.mp.android.apps.readActivity.view.animation.leftPageAnim.LeftNonePageAnim;
...
public class PageView extends View {
     ...
     * @return
     */
    public PageLoader getPageLoader(CollectionBookBean collBook) {
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader;
        }
