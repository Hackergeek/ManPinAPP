...
public class Content3040ModelImpl extends MBaseModelImpl implements IReaderBookModel {
    ...
    public Observable<CollectionBookBean> getBookInfo(CollectionBookBean collBookBean) {
        return getRetrofitObject(TAG).create(I3040API.class).getBookInfo(collBookBean.get_id().replace(TAG, "")).flatMap(new Function<String, ObservableSource<CollectionBookBean>>() {
            @Override
